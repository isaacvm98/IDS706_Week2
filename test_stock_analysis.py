...
class TestDataProcessing(unittest.TestCase):
    ...
    def test_extract_close_prices_structure(self):
        ...
        self.assertTrue(all(col.endswith('.MX') for col in self.df.columns if col != 'Date'))
...
class TestClustering(unittest.TestCase):
    ...
    def test_clustering_returns_correct_number_of_clusters(self):
        ...
        n_clusters = 2
        kmeans, cluster_groups = perform_kmeans_clustering(self.corr_matrix, n_clusters=n_clusters)
    ...
    def test_all_stocks_assigned_to_clusters(self):
        ...
        kmeans, cluster_groups = perform_kmeans_clustering(self.corr_matrix, n_clusters=2)
...
class TestTimeSeriesModeling(unittest.TestCase):
    ...
    def test_model_with_insufficient_data_raises_error(self):
        ...
        with self.assertRaises(ValueError):
            build_linear_model(small_data, 'WALMEX.MX_returns', 'BIMBOA.MX_returns', test_size=30)
